  ...
  return (
    <div className="flex h-screen">
      ...
      <aside className="w-64 bg-gradient-to-b from-purple-700 to-purple-900 text-white shadow-lg">
        <div className="p-6 text-2xl font-bold tracking-wide border-b border-white/10">Admin Panel</div>
        <nav className="mt-6">
      ...
      <main className="flex-1 bg-gray-50 p-6 overflow-y-auto">
        ...
        <div className="rounded-xl bg-white shadow p-6 min-h-[400px]">{renderContent()}</div>
      </main>
    </div>
  )
}
